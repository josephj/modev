...
o.push(m+'<br>*/</pre>');}
o.push('</div>');}}
return o.join('');};itself.jslint=itself;itself.edition='2010-03-06';return itself;}());
...
(function (a) {
    ...
    if (!JSLINT(input, {bitwise: true, eqeqeq: true, immed: true, forin: true, sub: false,
            newcap: true, nomen: false, onevar: true, plusplus: true, evil: true, 
            rhino: true, undef: true, white: true})) {
