...
class PHP_CodeSniffer_Standards_YahooStrict_YahooStrictCodingStandard extends PHP_CodeSniffer_Standards_CodingStandard
{
    ...
    public function getIncludedSniffs()
    {
        return array(
                'Yahoo',
                'Squiz/Sniffs/CSS',
                'Kohana/Sniffs/NamingConventions/ValidFunctionNameSniff.php',
                'Kohana/Sniffs/NamingConventions/ValidVariableNameSniff.php',
    ...
    {
        return array(
                'YahooStrict/Sniffs/WhiteSpace/CloseParenthesisSpacingSniff.php',
                'YahooStrict/Sniffs/WhiteSpace/OpenParenthesisSpacingSniff.php',
                'Yahoo/Sniffs/PHP/YintlFunctionsSniff.php',
