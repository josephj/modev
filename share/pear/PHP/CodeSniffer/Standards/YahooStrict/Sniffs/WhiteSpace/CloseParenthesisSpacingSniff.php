 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YahooStrict_Sniffs_WhiteSpace_CloseParenthesisSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        return array(T_CLOSE_PARENTHESIS);
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($stackPtr - 1)]['code'] === T_WHITESPACE && $tokens[($stackPtr - 2)]['content'] !== $phpcsFile->eolChar) {
        ...
        if ($error === true) {
            ...
            $message = "Close parenthesis must not be left surrounded by spaces. Found \"$found\"; expected \"$expected\"";
