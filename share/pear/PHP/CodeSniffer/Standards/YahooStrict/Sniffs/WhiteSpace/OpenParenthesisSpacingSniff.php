 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class YahooStrict_Sniffs_WhiteSpace_OpenParenthesisSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($stackPtr + 1)]['code'] === T_WHITESPACE && $tokens[($stackPtr + 1)]['content'] !== $phpcsFile->eolChar) {
        ...
        if ($error === true) {
            ...
            $message = "Open parenthesis must not be right surrounded by spaces. Found \"$found\"; expected \"$expected\"";
